  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          Настана грешка. Обидете се повторно или вратете се на почетната страница.
        </p>
  ...
  head: () => ({
    meta: [
      ...
      { title: "ФПСМ — Федерација за планинарство на Северна Македонија" },
      {
        name: "description",
        content:
          "Официјална страница на Федерацијата за планинарство на Северна Македонија: новости, календар на акции, комисии, клубови членки, обуки и документи.",
      },
      { name: "author", content: "ФПСМ" },
